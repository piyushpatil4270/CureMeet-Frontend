...
const Prescriptions = () => {
  ...
  const getAllPrescriptions=async()=>{
    try {
      const res=await axios.post("https://www.cure-meet2.kesug.com/prescriptions/patient/all",{patientId:1,date:moment.utc(selectedDate).format("DD-MM-YYYY")},{headers:{"Authorization":userToken,"userType":userType}})
