...
const Appointments = () => {
 ...
 const userType=localStorage.getItem("usertype")
  const fetchAppointments=async()=>{
    try {
      const res=await axios.post("http://localhost:5500/appointments/doctor/appointments",{date:selectedDate,doctorId:3},{headers:{"Authorization":userToken,"userType":userType}})
