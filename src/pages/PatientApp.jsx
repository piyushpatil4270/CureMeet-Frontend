...
const PatientApp = () => {
  ...
  const getAllAppointments=async()=>{
    try {
      const res=await axios.post("https://www.cure-meet2.kesug.com/appointments/patients/appointments",{patientId:1,date:moment.utc(selectedDate).format("DD-MM-YYYY")},{headers:{"Authorization":userToken,"userType":userType}})
